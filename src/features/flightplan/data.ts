...
const initialFlightPlanTemplate: FlightPlanInput = {
  ...
  performance: {
    availableTakeoffDistanceM: null,
    availableLandingDistanceM: null,
    takeoffPohM: null,
    takeoffCorrectedM: null,
    landingPohM: null,
    landingCorrectedM: null,
    aerodromeElevationFt: 47,
    temperatureC: 18,
    qnhHpa: 1013,
    landingAerodromeElevationFt: 47,
    landingTemperatureC: 18,
    landingQnhHpa: 1013,
