...
const AIRSPACE_LAYERS = [
  ...
  { typeName: 'mais:TMAS', kind: 'TMA', label: 'TMA' },
  { typeName: 'mais:TIA', kind: 'TIA', label: 'TIA' },
  { typeName: 'mais:TIZ', kind: 'TIZ', label: 'TIZ' },
  { typeName: 'mais:RSTA', kind: 'R', label: 'R' },
  { typeName: 'mais:DNGA', kind: 'D', label: 'D' },
...
function normalizeFeature(layer, feature, index) {
  ...
  return {
    ...
    lower: normalizeAltitudeValue(properties.LOWER),
    upper: normalizeAltitudeValue(properties.UPPER),
